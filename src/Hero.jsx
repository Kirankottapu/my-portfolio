...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full min-h-screen pt-20 overflow-hidden flex items-center justify-center md:justify-end text-white"
    >
      {/* Background Image */}
      <div
      ...
      <div className="relative z-10 max-w-xl sm:max-w-2xl mx-auto md:mx-0 px-4 sm:px-6 md:px-8 lg:px-16 text-center md:text-right">
        ...
        <a
          href="#projects"
          className="inline-block bg-blue-500 text-black font-bold px-8 py-3 sm:px-10 sm:py-4 rounded-full shadow-lg hover:scale-105 transform transition duration-300"
        >
          View Projects
        </a>
      </div>
